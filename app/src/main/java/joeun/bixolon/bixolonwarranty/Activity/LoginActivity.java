...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            HttpsURLConnection conn = ssl.postHttps("http://192.168.2.30:3000",1000,1000);
            //HttpsURLConnection conn = null;

            Long result = 0L;
            try{

                //URL url = new URL("https://api.graygram.com/login/username");
                //conn = (HttpsURLConnection) url.openConnection();

                URL url = new URL("http://192.168.2.30:3000/employees");
                conn = (HttpsURLConnection) url.openConnection();
                conn.setDoOutput(true);
                conn.setRequestMethod("POST");
                conn.setRequestProperty("Accept", "application/json");

                String input = "id=" + URLEncoder.encode("1001", "UTF-8") +
                               "&password=" + URLEncoder.encode("39", "UTF-8");

                //String input = new Gson().toJson(this.params);
                //String input = "{'username' : '39'}";
                ...
                Log.i("================>>>>>","StateCode ( " + result + " ) : " + conn.getResponseMessage());
            } catch (IOException x) {
                Log.e("================>>>>>","Error : ", x);
            }
            */
